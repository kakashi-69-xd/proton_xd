...
// source-hash: f3117be7e77608ffe643b5adb30b54783d8cac48
let wasm;
 ...
 * @param {any} perms
 */
export function dev(perms) {
  wasm.dev(addHeapObject(perms));
}

/**
 * @param {any} perms
 */
export function build(perms) {
  wasm.build(addHeapObject(perms));
}
